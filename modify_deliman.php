...
<html>
<head>
	<title>Modify Delivery-man</title>
...
<body>
	 <div class="" style="width: 70%; float: center; padding-left: 50PX;"> 
		...
		<?php 
			$query = "SELECT id, name, email, phonenumber, password, salary, address, region FROM users NATURAL JOIN deliman WHERE user_type='deliman' ORDER BY name ASC";
		...
		<div class="deletenav" style="position: fixed; width: 100%px; float: left; z-index: 1; top: 0; right: 0; padding-top: 100px; padding-right: 250px;">
			<form method="post" action="update_deliman.php">
				<!---<div class="container">--->
					<div class="">
						<div class="row">
							<div class="">
...
/*
	if(isset($_POST['update']))
	{
		$id = $_POST['id'];
	   	...
	   	echo"<script>window.location='http://localhost/projects/rms/update_deliman.php'</script>";
