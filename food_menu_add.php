...
<body>
	...
	<div class="header">
  	...
  	<div class="pagetitle">
		<h2>Add a New Food Item to the Menu</h2>
	</div>

  	<div class="background">
      	<form action="food_menu_add.php" method="post">
            <div class="form" style="width:100%; height:500px; padding-left: 200px; padding-right: 200px;">
                ...
                <textarea class="form-control" cols="50" rows="5"  id="descr" type="text" name="descr" required></textarea>
...
<?php
    if(isset($_POST['create'])){
      ...
      $descr         = $_POST['descr'];
        ...
        VALUES ('".$_POST["name"]."','".$_POST["image"]."', '".$_POST["price"]."', 'food', '".$_POST["descr"]."')";

        if(mysqli_query($conn, $sql)){
          echo '<script>alert("New food item added!")</script>';
